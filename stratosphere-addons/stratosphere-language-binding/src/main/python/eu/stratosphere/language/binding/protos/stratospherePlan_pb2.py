...
_PROTOPLAN_KEYTYPEPAIR = _descriptor.Descriptor(
  name='KeyTypePair',
  full_name='eu.stratosphere.language.binding.protos.ProtoPlan.KeyTypePair',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='eu.stratosphere.language.binding.protos.ProtoPlan.KeyTypePair.key', index=0,
      number=1, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='eu.stratosphere.language.binding.protos.ProtoPlan.KeyTypePair.value', index=1,
...
_PROTOPLAN_VERTEX = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='paramTypes', full_name='eu.stratosphere.language.binding.protos.ProtoPlan.Vertex.paramTypes', index=4,
...
_PROTOPLAN = _descriptor.Descriptor(
  ...
  nested_types=[_PROTOPLAN_KEYVALUEPAIR, _PROTOPLAN_KEYTYPEPAIR, _PROTOPLAN_VERTEX, ],
  enum_types=[
...
_PROTOPLAN_KEYTYPEPAIR.fields_by_name['value'].enum_type = _PROTOPLAN_VALUETYPE
_PROTOPLAN_KEYTYPEPAIR.containing_type = _PROTOPLAN;
...
_PROTOPLAN_VERTEX.fields_by_name['paramTypes'].message_type = _PROTOPLAN_KEYTYPEPAIR
...
class ProtoPlan(_message.Message):
  ...
  class KeyTypePair(_message.Message):
    __metaclass__ = _reflection.GeneratedProtocolMessageType
    DESCRIPTOR = _PROTOPLAN_KEYTYPEPAIR
